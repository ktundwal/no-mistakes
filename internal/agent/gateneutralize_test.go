...
// settings/instructions; every other harness is refused rather than launched
// with project instructions loaded.
...
// TestNeutralizesGateInstructions_FalseWithoutOptOut proves verified adapters
// do NOT claim neutralization when the repo did not opt out - the gate only
...
// closed for an unsupported harness and admits every verified one.
